# Documentação ConectaFapes

*Este repositório contém todos os recursos de documentação e gestão de projeto relativos ao projeto “Conecta FAPES: Uma plataforma de apoio à Pesquisa, Desenvolvimento e Inovação”.* 
**Acesse em https://conectafapes.docs.leds.dev.br/**
...
2. **Clone o Fork**:
   - Depois de criar o fork, clone o repositório para o seu ambiente local:
     ```bash
     git clone https://github.com/seu-usuario/leds-conectafapes-documentation.git
     ```
