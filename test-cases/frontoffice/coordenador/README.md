...
| `prestacao-contas/financeira/detalhe-comprovacao-transacao/comprovar-debito` | `/coordenador/prestacao-financeira/detalhes/:paymentId` | comprovar débito (exclusivo para transações de Débito) |
