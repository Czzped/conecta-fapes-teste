...
| **saldoAlocavelEmProgramas** (Parceria, derivado) | Saldo da Parceria disponivel para aportes em Programas, descontando a reserva de Acao Transversal quando aplicavel: `SUM(AporteFinanceiro.valorInvestido) - valorReservadoAcaoTransversal - SUM(AporteFinanceiroParceriaPrograma.valor)`. | [M010 parcerias](../implementation/modules/M010-planejamento-estrategia/parcerias/modelo-estrutural.md) |
...
| **Rubrica** | Categoria orcamentaria/despesa usada no planejamento e na execucao do gasto, como diarias, passagens, bolsas, servicos de terceiros ou material permanente. | [M013](../implementation/modules/M013-gestao-orcamentaria-projeto/README.md), [M008](../implementation/modules/M008-cadastros-corporativos/epics/EPIC-M008-003.md) |
| **Acao Transversal** | Reserva financeira institucional calculada na Parceria pelo M010 e gerida no M016 para custear despesas operacionais/administrativas da agencia, conforme politica normativa parametrizada. | [Domain 08](domains/08-acao-transversal.md), [M016 Acao Transversal](../implementation/modules/M016-contabilidade-financeiro/acao-transversal/README.md) |
| **Coordenador Outorgado da Acao Transversal** | Servidor publico vinculado a FAPES autorizado pela Diretoria Executiva, por Termo de Outorga, a gerir recursos de Acao Transversal. Nao e uma pessoa global fixa nem deve ser inferido automaticamente do coordenador do projeto/parceria; sua designacao e rastreada por TO e recurso abrangido. | [Domain 08](domains/08-acao-transversal.md) |
| **ReservaAcaoTransversal** | Valor reservado a partir de um `AporteFinanceiro` original ou aditivo. No M016, a reserva e classificada em conta contabil, fundo financeiro e centro de custo antes de ser planejada por rubricas. | [M016 Acao Transversal](../implementation/modules/M016-contabilidade-financeiro/acao-transversal/README.md) |
