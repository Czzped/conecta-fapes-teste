...
|------------|-----------------|
| Funcionario da FAPES | Cria formularios e respostas; cria copias de formularios existentes independentemente da autoria do formulario original |
| Autor do registro | Edita formularios e respostas de sua autoria, respeitando as restricoes de estado aplicaveis |
| Gestor da FAPES | Publica, reverte publicacao, inativa, exclui, consulta formularios e gerencia categorias |
