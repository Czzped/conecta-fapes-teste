...
|------------|-----------------|
| Funcionario da FAPES | Cria formularios, cria copias de formularios existentes independentemente da autoria do formulario original e gerencia categorias de formulario |
| Usuario logado | Cria respostas a formularios |
...
| RegistrarRespostaFormulario | Command | Iniciar resposta para formulario utilizado por outro modulo | formularioId, respostas | `RespostaFormulario` criada em estado RASCUNHO, com dataRegistro, dataUltimaAlteracao, usuarioCriacao, usuarioUltimaAlteracao e resultado calculado quando aplicavel | RN09, RN12, RN18-RN26, RN28 | Formulario "Utilizado" ou "Inativo"; usuario autenticado | USUARIO_NAO_AUTENTICADO, FORMULARIO_NAO_ENCONTRADO, RESPOSTA_INVALIDA | Usuario logado ou modulo interno em nome do usuario respondedor |
| AtualizarRespostaFormulario | Command | Editar resposta em rascunho | respostaId, respostas | `RespostaFormulario` em RASCUNHO atualizada com dataUltimaAlteracao, usuarioUltimaAlteracao e resultado recalculado quando aplicavel | RN18-RN26, RN29 | Resposta existente em estado RASCUNHO; usuario autenticado solicitante e autor da resposta | USUARIO_NAO_AUTENTICADO, USUARIO_NAO_AUTORIZADO, RESPOSTA_NAO_ENCONTRADA, RESPOSTA_NAO_EDITAVEL, RESPOSTA_INVALIDA | Autor da resposta |
| EnviarRespostaFormulario | Command | Enviar resposta em rascunho | respostaId | `RespostaFormulario` em ENVIADA, com dataEnvio registrada e resultado calculado/recalculado quando aplicavel | RN18-RN26, RN29 | Resposta existente em estado RASCUNHO; usuario autenticado solicitante e autor da resposta | USUARIO_NAO_AUTENTICADO, USUARIO_NAO_AUTORIZADO, RESPOSTA_NAO_ENCONTRADA, RESPOSTA_NAO_EDITAVEL, RESPOSTA_INVALIDA | Autor da resposta |
