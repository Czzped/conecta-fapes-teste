...
| RegistrarRespostaFormulario | Command | Registrar resposta para formulario utilizado por outro modulo | formularioId, respostas | `RespostaFormulario` registrada com dataRegistro, dataUltimaAlteracao, usuarioCriacao, usuarioUltimaAlteracao e resultado calculado quando aplicavel | RN09, RN12, RN18-RN23 | Formulario "Utilizado" ou "Inativo" | FORMULARIO_NAO_ENCONTRADO, RESPOSTA_INVALIDA | Modulo interno |
| AtualizarRespostaFormulario | Command | Alterar resposta registrada para uso existente | respostaId, respostas | `RespostaFormulario` atualizada com dataUltimaAlteracao, usuarioUltimaAlteracao e resultado recalculado quando aplicavel | RN18-RN23 | Resposta existente; uso externo ainda permite alteracao no modulo consumidor | RESPOSTA_NAO_ENCONTRADA, RESPOSTA_INVALIDA | Modulo interno |
| ConsultarRespostaFormulario | Query | Consultar resposta registrada e seu resultado | respostaId | `RespostaFormulario` | RN18-RN23 | Resposta existente | RESPOSTA_NAO_ENCONTRADA | Gestor da FAPES, Modulo interno |
| ListarRespostasFormulario | Query | Listar respostas de um formulario | formularioId | Lista de respostas | RN09, RN12 | Formulario informado | FORMULARIO_NAO_ENCONTRADO | Gestor da FAPES, Modulo interno |
