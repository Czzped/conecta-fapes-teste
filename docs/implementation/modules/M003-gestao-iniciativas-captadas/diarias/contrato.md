...
|--------|---------------|----------------|
| SolicitacaoDiariaAlocada | Coordenador cria solicitacao com saldo disponivel antes do inicio da viagem | solicitacaoDiariaId, iniciativaId, alocacaoBolsistaRef, abrangenciaRef, tipoDiariaRef, parametroCalculoDiariaRef, valorUnitarioDiaria, rubricaProjetoRef, transacaoComprometimentoRef |
| NotificacaoAceiteDiariaPendenteCriada | Existe diaria pendente de aceite para bolsista | solicitacaoDiariaId, alocacaoBolsistaRef, iniciativaId, destino, partida |
