# Processo: Liberacao de Parcelas da Projeto
...
**Pre-condicao:** Projeto ativa; parcela N-1 no estado LIBERADA (para N > 1); nenhuma SolicitacaoLiberacaoParcela ativa para a mesma parcela.
...
| 3 | Ciclo de fomento da projeto recebe marco de liberacao da parcela N | Sistema | `EstagioCicloFomento` |
...
|----------|---------------|
| Lista de parcelas | Exibe todas as `ParcelaProjeto` da projeto com numero, valor previsto, estado e data prevista |
