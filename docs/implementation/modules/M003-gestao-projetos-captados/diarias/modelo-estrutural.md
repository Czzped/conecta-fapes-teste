...
| AlocacaoBolsista | M009 | Identifica o bolsista do projeto/projeto que recebera a diaria; a propria alocacao ja contem a pessoa fisica |
| RubricaProjeto | M013 | Informa saldo/limite da rubrica de diaria da projeto |
...
classDiagram
    ...
    SolicitacaoDiaria "*" --> "1" Projeto : projetoId
...
|---------|----------------|------|---------|-------------|-----------|
| `projetoId` | 1 | FK | `Projeto` | M003 | Projeto a qual a solicitacao pertence |
...
| RubricaProjeto | M013 | Rubrica ja prevista no orcamento da projeto, com total, alocado, utilizado e saldo |
...
- `alocacaoBolsistaRef` deve apontar para entidade do M009 e deve pertencer a mesma projeto da solicitacao.
