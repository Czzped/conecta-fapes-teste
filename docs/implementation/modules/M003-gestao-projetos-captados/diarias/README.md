...
| M009 | Validacao de bolsistas/alocacoes da projeto |
...
O M003 deve tratar a diaria como **solicitacao operacional da projeto**. O modelo proprio do subfluxo fica restrito a uma entidade:
...
- Cada solicitacao deve possuir exatamente uma `alocacaoBolsistaRef` valida no M009, vinculada a projeto.
