...
Durante a execucao de um projeto financiado pela FAPES, situacoes podem exigir a suspensao temporaria ou o encerramento definitivo do projeto. A suspensao pode ser solicitada pelo coordenador (por motivo de forca maior, licenca, ou replanejamento) ou determinada pela FAPES (por irregularidade, inadimplencia ou descumprimento de obrigacoes).
...
O encerramento definitivo de um projeto pode ocorrer por conclusao natural, por decisao do coordenador ou por determinacao da FAPES. Antes de encerrar, o sistema deve verificar que todas as prestacoes de contas foram submetidas e aprovadas (M014) e que todas as bolsas ativas foram encerradas (M009). Um projeto encerrado e irreversivel.

> Bolsas sao gerenciadas pelo modulo M009. Pagamentos sao gerenciados pelo modulo M004. Prestacao de contas e gerenciada pelo modulo M014. Este modulo coordena a suspensao e finalizacao verificando pendencias nesses modulos.
...
| RN08 | A suspensao pode ser solicitada pelo coordenador ou determinada pela FAPES. | Must |
