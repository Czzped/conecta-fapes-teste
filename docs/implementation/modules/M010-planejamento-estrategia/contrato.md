...
> `saldoAlocavelEmProgramas` retornado na criacao e sempre `0.0` — Parceria recem-criada nao possui `AporteFinanceiro`, Taxa de Gestao de Parcerias nem `AporteFinanceiroParceriaPrograma`. O saldo e derivado (RN14/RN22) e evolui conforme aportes e taxas de gestao sao registrados.
