...
> `saldoAlocavelEmProgramas` retornado na criacao e sempre `0.0` — Parceria recem-criada nao possui `AporteFinanceiro`, reserva de Acao Transversal nem `AporteFinanceiroPrograma`. O saldo e derivado (RN14/RN22) e evolui conforme aportes e reservas sao registrados.
