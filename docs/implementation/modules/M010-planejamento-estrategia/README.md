...
| [Programas — Estrutural](programas/modelo-estrutural.md) / [Comportamental](programas/modelo-comportamental.md) | Programas + Recursos + Comite + AporteFinanceiroParceriaPrograma |
| [Parcerias — Estrutural](parcerias/modelo-estrutural.md) / [Comportamental](parcerias/modelo-comportamental.md) | Parcerias + Vigencias + Aportes + Documentos |
...
| RN04 | Cada aporte financeiro deve ter origem em uma Instituicao cadastrada em M008. | Must | parcerias |
...
| RN10 | Uma parceria deve estar vinculada a pelo menos uma Instituicao (M008). | Must | parcerias |
...
| RN14 | A Parceria possui `saldo = SUM(AporteFinanceiro.valorInvestido) − SUM(AporteFinanceiroParceriaPrograma.valor)`, sempre `>= 0`. | Must | parcerias |
...
| RI1 | Nao e possivel excluir um programa que possua editais vinculados. | Must | programas |
