...
| CadastrarContaBancaria | Command | Registrar conta bancaria e sua relacao com o escopo financeiro | banco, agencia, numeroConta, referencia | `ContaBancaria` criada | RN03, RI2 | Escopo financeiro informado | Conta duplicada, referencia invalida | Nao | Gestor financeiro | API interna/backoffice a definir |
