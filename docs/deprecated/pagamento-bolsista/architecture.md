...
> **Documento depreciado.** A documentacao canonica deste modulo migrou para [implementation/modules/M004-pagamento-bolsista/](../../implementation/modules/M004-pagamento-bolsista/README.md). Detalhes de infraestrutura (MinIO, Redis, Hangfire) foram migrados para [architecture/04-dados-e-operacao.md](../../architecture/04-dados-e-operacao.md). Ver [ADR-006](../../architecture/adr/ADR-006-reconciliacao-m004-pagamento-bolsista.md).
