...
> **Documento depreciado.** A arquitetura do backend e documentada em [architecture/01-visao-geral.md](../../architecture/01-visao-geral.md) e [ADR-001](../../architecture/adr/ADR-001-backend-csharp-clean-architecture-cqrs.md). Detalhes de infraestrutura deste modulo (SERPRO, MinIO, backend separado) estao em [architecture/04-dados-e-operacao.md](../../architecture/04-dados-e-operacao.md). Modelo de dominio em [M014/modelo-estrutural.md](../../implementation/modules/M014-prestacao-contas/modelo-estrutural.md).
