# EPA-03 — Modalidades de Bolsa

| Atributo | Valor |
|----------|-------|
| **Modulos backend** | M001 |
| **Produto** | Portal Admin |
| **Status** | Em producao |

## Jornada

O operador cadastra e versiona modalidades de bolsa, registra resolucoes da agencia, define niveis com valores monetarios e publica versoes para uso nos editais e projetos.
...
- **Acerto de cadastro de versao de bolsa**: correcao de valores e vigencia de versoes ja cadastradas (pendencia Q1)
